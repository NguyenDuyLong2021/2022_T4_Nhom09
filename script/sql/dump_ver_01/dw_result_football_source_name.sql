...
LOCK TABLES `source_name` WRITE;
/*!40000 ALTER TABLE `source_name` DISABLE KEYS */;
INSERT INTO `source_name` VALUES (1,'www.flashscore.com');
/*!40000 ALTER TABLE `source_name` ENABLE KEYS */;
UNLOCK TABLES;
